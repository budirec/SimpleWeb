      ...
      <form id="testimony-form" action="<?= base_url('testimony/add'); ?>">
        <div class="form-group">
          <textarea name="content" class="form-control" id="testimony-content" rows="3" 
                    placeholder="Put your testimony here..."></textarea>
